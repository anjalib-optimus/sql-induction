...
SELECT User_Name,Product_Name ,Ordered_Quantity,Amount_Paid,Last_Transaction_Date,Balance FROM
...
ELSE 0.0 END)*Cost_Per_Item-SUM(CASE WHEN Transaction_Type='Payment' 
THEN Transaction_Amount ELSE 0.0 END) AS Balance
